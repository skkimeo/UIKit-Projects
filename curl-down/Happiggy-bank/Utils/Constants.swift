...
extension NoteCell {
    ...
    enum Metric {
        ...
        /// 플레이스 홀더 뷰 바운드
        static let placeHolderViewBounds = CGRect(
            x: 0,
            y: 0,
            width: NoteListViewController.Metric.noteImageWidth,
            height: NoteListViewController.Metric.noteImageHeight
        )
        
        /// 쪽지 이미지 애니메이션 지속 시간: 1
        static let noteAnimationDuration: CFTimeInterval = 1
        
        /// 쪽지 내용 애니메이션 지속 시간: 0.2
        static let contentsAnimationDuration = CATransition.transitionDuration
        
        /// 쪽지 내용 애니메이션 딜레이 시간: 0.3
        static let contentsAnimationDelay: CFTimeInterval = 0.3
    }
}
